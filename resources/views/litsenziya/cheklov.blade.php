...
<style>
    ...
    .ikon-doira i { font-size: 38px; color: #4f46e5; }
...
<div class="blok-karta">
    ...
    <div class="ikon-doira"><i class="bi bi-graph-up-arrow"></i></div>
    <div class="modul-belgi">{{ $sarlavha }}</div>
    <h1>Tarif limiti</h1>
    <div class="izoh">{{ $matn }}</div>
    ...
    <a href="mailto:adilshod.82@gmail.com?subject=Tarif%20kengaytirish&body=Salom!%20Dokon%20kodim%3A%20{{ urlencode($dukonKodi) }}" class="aloqa-tugma">
...
function telegramgaYubor(e) {
    e.preventDefault();
    const kod = document.getElementById('dukon-kodi').textContent.trim();
    const xabar = `Salom! Tarifimni kengaytirish kerak. Do'kon kodim: ${kod}`;
